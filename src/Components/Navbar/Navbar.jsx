...
function Navbar() {
  ...
  return (
    ...
    >
      ...
      {isOpen && (
        <div className="absolute top-20 left-1/2 transform -translate-x-1/2 w-4/5 bg-[#050414] bg-opacity-65 backdrop-filter backdrop-blur-lg z-50 rounded-lg shadow-lg md:hidden">
